...
useHead({
  title: 'Teams Management',
  meta: [
    { name: 'description', content: 'Collaborative team management platform for organizing tasks, projects, and communication. Work together seamlessly with your team.' },
    { property: 'og:title', content: 'Teams Management - Collaborate Better' },
