...
// Dynamic SEO based on team name
const route = useRoute()
const teamName = ref('Team')

useHead(() => ({
  title: `${teamName.value} - Team Details`,
  meta: [
    { name: 'description', content: `View and manage ${teamName.value} details, members, tasks, and announcements` }
  ]
}))
